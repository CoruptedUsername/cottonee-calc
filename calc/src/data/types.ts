...
const IF: TypeChart = extend(true, {}, SV, {
  '???': {Lemon: 1, Silly: 1},
  Normal: {Lemon: 1, Silly: 2},
  Grass: {Lemon: 1, Silly: 2},
  Fire: {Lemon: 1, Silly: 1},
  Water: {Lemon: 0.5, Silly: 1},
  Electric: {Lemon: 1, Silly: 0.5},
  Ice: {Lemon: 0.5, Silly: 1},
  Flying: {Lemon: 1, Silly: 1},
  Bug: {Lemon: 2, Silly: 2},
  Poison: {Lemon: 2, Silly: 1},
  Ground: {Lemon: 0.5, Silly: 1},
  Rock: {Lemon: 2, Silly: 1},
  Fighting: {Lemon: 1, Silly: 1},
  Psychic: {Lemon: 2, Silly: 1},
  Ghost: {Lemon: 1, Silly: 0.5},
  Dragon: {Lemon: 1, Silly: 1},
  Dark: {Lemon: 1, Silly: 0.5},
  Steel: {Lemon: 0.5, Silly: 1},
  Fairy: {Lemon: 1, Silly: 1},
  Stellar: {Lemon: 1, Silly: 1},
  Lemon: {
    '???': 1,
    Normal: 1,
    Grass: 1,
...
export const TYPE_CHART = [{}, RBY, GSC, ADV, DPP, BW, XY, SM, SS, SV, RBY, BW, SV, SV, SV, SV, SV,
  SV, SV, SV, SV, SV, XY]; // NewGenChange
